...
export function BottomNav() {
  const item =
    "flex min-h-[60px] flex-1 flex-col items-center justify-center gap-1 text-muted hover:text-ink md:min-h-0 md:flex-none md:flex-row md:gap-2 md:px-4 md:py-2.5";
  const labelCls = "font-mono text-[0.625rem] uppercase tracking-[0.12em]";
  ...
  return (
    ...
    >
      ...
      <Link href="/dashboard?view=memories" className={item}>
